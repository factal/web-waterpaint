...
export type PigmentColor = [number, number, number]

export type PigmentColorTable = readonly [
  PigmentColor,
  PigmentColor,
  PigmentColor,
]

export type PigmentStrengthTable = readonly [number, number, number]

export interface PigmentSpectralSettings {
